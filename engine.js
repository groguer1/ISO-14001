...
(function (global) {
  ...
  function file(n) { return 'iso14001-modulo' + n + '.html'; }
  ...
  function buildDocumentPDF(title, contentText, filename) {
    ...
    function drawHeader() {
      ...
      doc.setFontSize(13);
      doc.text('ISOTECNIA · CONSULTOR ISO 14001 CERTIFICADO', marginX, 30);
    ...
    function drawFooter(pageNum) {
      ...
      doc.setFont('helvetica', 'normal');
      doc.text('Isotecnia — Curso Consultor ISO 14001 · Material de apoyo', marginX, pageH - 28);
  ...
  var Deck = {
    ...
    render_cardgrid: function (slide) {
      ...
      wrap.className = 'slide-inner';
      var toneClass = {
        F: 'tone-verde', D: 'tone-rojo', O: 'tone-azul', A: 'tone-acento',
        P: 'tone-azul', C: 'tone-verde', X: 'tone-gris'
      };
    ...
    render_callout: function (slide) {
      var wrap = document.createElement('div');
      wrap.className = 'slide-inner';
      var icons = { info: 'ℹ️', alerta: '⚠️', clave: '🎯', legal: '⚖️', peligro: '☣️' };
    ...
    render_auditortip: function (slide) {
      var wrap = document.createElement('div');
      wrap.className = 'slide-inner';
      var card = document.createElement('div');
      card.className = 'auditortip-card';
      card.innerHTML = '<h3>' + esc(slide.title) + '</h3><div class="at-body">' + slide.html + '</div>';
      wrap.appendChild(card);
      return wrap;
    },
